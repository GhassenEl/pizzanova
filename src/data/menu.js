...
const IMG = {
  ...
  baked:
    'https://images.unsplash.com/photo-1555072956-7758afb20e8f?auto=format&fit=crop&w=900&q=80',
  flat:
...
const PIZZA_ITEMS = [
  ...
  },
  {
    ...
    emoji: '🍍',
    badge: '-10%',
    tags: ['classique', 'viande', 'sucré-salé'],
    image: IMG.slice,
    ingredients: ['Sauce tomate', 'Mozzarella', 'Jambon cuit', 'Ananas', 'Origan'],
    description:
      'Alliance sucre-sale : jambon tendre, ananas juteux et mozzarella fondante. Un classique controversé et addictif.',
  },
  {
    id: 'reine',
    name: 'Reine',
    ...
    emoji: '👑',
    badge: null,
    tags: ['classique', 'viande', 'champignon'],
    image: IMG.wood,
    ingredients: ['Sauce tomate', 'Mozzarella', 'Jambon', 'Champignons', 'Olives'],
    description:
      'La reine des tables : jambon, champignons et olives sur sauce tomate. Equilibree et genereuse.',
  },
  {
    id: 'napolitaine',
    name: 'Napolitaine',
    ...
    emoji: '🫒',
    badge: null,
    tags: ['classique', 'anchois', 'méditerranée'],
    image: IMG.rustic,
    ingredients: ['Sauce tomate', 'Mozzarella', 'Anchois', 'Olives noires', 'Capres', 'Origan'],
    description:
      'Saveurs marines et mediterraneennes : anchois, olives, capres et origan. Caractere affirme.',
  },
  {
    id: 'merguez',
    name: 'Merguez Orientale',
    category: 'speciales',
    price: 29,
    discountPct: 12,
    rating: 4.8,
    ...
    emoji: '🌶️',
    badge: '-12%',
    tags: ['spécial', 'viande', 'épicé', 'local'],
    image: IMG.loaded,
    ingredients: ['Sauce tomate harissa', 'Mozzarella', 'Merguez', 'Poivrons', 'Oignons', 'Coriandre'],
    description:
      'Inspiration tunisienne : merguez grillees, harissa douce, poivrons et coriandre. Chaleur et caractere.',
  },
  {
    id: 'fruits-mer',
    name: 'Fruits de Mer',
  ...
  },
  {
    ...
    emoji: '💚',
    badge: 'Nouveau',
    tags: ['spécial', 'fromage', 'premium', 'tomate'],
    image: IMG.thin,
    ingredients: ['Sauce tomate', 'Mozzarella', 'Burrata fraiche', 'Tomates cerises', 'Basilic', "Huile d'olive"],
    description:
      'Burrata cremeuse ajoutee apres cuisson, tomates cerises confites et basilic. Fraicheur premium.',
  },
  {
    id: 'meat-lovers',
    name: 'Meat Lovers',
    ...
    emoji: '🥩',
    badge: '-15%',
    tags: ['spécial', 'viande', 'généreux'],
    image: IMG.baked,
    ingredients: ['Sauce tomate', 'Mozzarella', 'Pepperoni', 'Jambon', 'Merguez', 'Bacon'],
    description:
      'Pour les carnivores : pepperoni, jambon, merguez et bacon. Quatre viandes, une seule pizza.',
  },
  {
    id: 'caprese',
    name: 'Caprese Fraiche',
    category: 'vegetariennes',
    price: 24,
    discountPct: 0,
    rating: 4.5,
    ...
    emoji: '🍅',
    badge: null,
    tags: ['végé', 'tomate', 'léger', 'fromage'],
    image: IMG.flat,
    ingredients: ['Sauce tomate', 'Mozzarella', 'Tomates fraiches', 'Basilic', 'Vinaigre balsamique'],
    description:
      'Style Caprese : tomates fraiches, mozzarella, basilic et filet de balsamique. Legere et estivale.',
  },
  {
    id: 'pesto-roquette',
    name: 'Pesto Roquette',
    ...
    emoji: '🌿',
    badge: '-8%',
    tags: ['végé', 'pesto', 'léger'],
    image: IMG.veggie,
    ingredients: ['Base pesto', 'Mozzarella', 'Roquette', 'Tomates sechees', 'Parmesan', 'Pignons'],
    description:
      'Base pesto maison, roquette croquante, tomates sechees et copeaux de parmesan. Fraiche et aromatique.',
  },
  {
    id: 'orientale-veg',
    name: 'Orientale Vege',
    ...
    emoji: '🫑',
    badge: null,
    tags: ['végé', 'épicé', 'légumes'],
    image: IMG.gourmet,
    ingredients: ['Sauce tomate harissa', 'Mozzarella', 'Aubergines', 'Poivrons', 'Olives', 'Cumin'],
    description:
      'Legumes grilles, pointe de harissa et cumin. Voyage oriental 100% vegetarien.',
  },
  {
    id: 'nutella',
    name: 'Nutella Banane',
    ...
    image: IMG.dessert,
    ingredients: ['Pate a pizza sucree', 'Nutella', 'Banane fraiche', 'Noisettes concassees', 'Sucre glace'],
    description:
      'Dessert partageable : croute chaude, genereux Nutella, rondelles de banane et noisettes croquantes. Saupoudree de sucre glace.',
  },
  {
    id: 'oreo',
    name: 'Cookie Crush',
    ...
    tags: ['dessert', 'chocolat', 'sucré'],
    image: IMG.sweet,
    ingredients: ['Creme patissiere', 'Cookies ecrases', 'Chocolat noir fondu', 'Coulis caramel'],
    description:
      'Pizza dessert gourmande : creme patissiere, cookies croustillants, chocolat noir et filet de caramel.',
  },
  {
    id: 'pomme-caramel',
    name: 'Pomme Caramel',
    ...
    emoji: '🍎',
    badge: '-5%',
    tags: ['dessert', 'fruit', 'sucré'],
    image: IMG.dessert,
    ingredients: ['Beurre', 'Pommes caramelisees', 'Cannelle', 'Creme fraiche', 'Coulis caramel'],
    description:
      'Pommes fondantes a la cannelle, nappage caramel et pointe de creme. Un dessert sur pate croustillante.',
  },
];
